INSERT INTO Utilisateur VALUES(DEFAULT, 'toto', 'toto@tata.fr', 'toto', 'https://cdn.myanimelist.net/images/manga/3/179023.jpg?s=e79cbbeb57b734d4b5f6d29f94162627');
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.6 FROM Manga WHERE titre = 'Shingeki no Kyojin';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 9.38 FROM Manga WHERE titre = 'Berserk';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 9.14 FROM Manga WHERE titre = 'One Piece';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.52 FROM Manga WHERE titre = 'Tokyo Ghoul';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.06 FROM Manga WHERE titre = 'Naruto';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.73 FROM Manga WHERE titre = 'One Punch-Man';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.28 FROM Manga WHERE titre = 'Boku no Hero Academia';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.72 FROM Manga WHERE titre = 'Death Note';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 7.67 FROM Manga WHERE titre = 'Bleach';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 9.05 FROM Manga WHERE titre = 'Oyasumi Punpun';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.47 FROM Manga WHERE titre = 'Horimiya';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 7.61 FROM Manga WHERE titre = 'Fairy Tail';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 9.08 FROM Manga WHERE titre = 'Fullmetal Alchemist';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.86 FROM Manga WHERE titre = 'Solo Leveling';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.27 FROM Manga WHERE titre = 'Yakusoku no Neverland';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.27 FROM Manga WHERE titre = 'Kimetsu no Yaiba';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.86 FROM Manga WHERE titre = 'Koe no Katachi';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.22 FROM Manga WHERE titre = 'Tokyo Ghoul:re';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.62 FROM Manga WHERE titre = 'Chainsaw Man';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 9.12 FROM Manga WHERE titre = 'Vagabond';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.68 FROM Manga WHERE titre = 'Hunter x Hunter';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.93 FROM Manga WHERE titre = 'Vinland Saga';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.02 FROM Manga WHERE titre = 'Deadman Wonderland';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.13 FROM Manga WHERE titre = 'Gantz';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.94 FROM Manga WHERE titre = 'Kaguya-sama wa Kokurasetai: Tensai-tachi no Renai Zunousen';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 7.74 FROM Manga WHERE titre = 'Nisekoi';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.02 FROM Manga WHERE titre = 'Shokugeki no Souma';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.28 FROM Manga WHERE titre = 'Komi-san wa, Comyushou desu.';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 7.66 FROM Manga WHERE titre = 'Nanatsu no Taizai';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 9.23 FROM Manga WHERE titre = 'JoJo no Kimyou na Bouken Part 7: Steel Ball Run';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.51 FROM Manga WHERE titre = 'Jujutsu Kaisen';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 7.88 FROM Manga WHERE titre = 'Akame ga Kill!';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.43 FROM Manga WHERE titre = 'Bakuman.';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.45 FROM Manga WHERE titre = 'Noragami';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 9.09 FROM Manga WHERE titre = 'Monster';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.9 FROM Manga WHERE titre = 'Haikyuu!!';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.94 FROM Manga WHERE titre = '20th Century Boys';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.19 FROM Manga WHERE titre = 'Ao Haru Ride';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.18 FROM Manga WHERE titre = 'JoJo no Kimyou na Bouken Part 6: Stone Ocean';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.17 FROM Manga WHERE titre = 'Uzumaki';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.32 FROM Manga WHERE titre = 'Claymore';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.41 FROM Manga WHERE titre = 'Kaichou wa Maid-sama!';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.6 FROM Manga WHERE titre = 'Pandora Hearts';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 7.95 FROM Manga WHERE titre = 'Ao no Exorcist';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.44 FROM Manga WHERE titre = 'Kuroshitsuji';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 7.75 FROM Manga WHERE titre = 'Black Clover';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.29 FROM Manga WHERE titre = 'D.Gray-man';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.67 FROM Manga WHERE titre = 'ReLIFE';
...
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.29 FROM Manga WHERE titre = 'Ansatsu Kyoushitsu';
INSERT INTO MangaLectureFini (Id_Utilisateur, Id_Manga, note) SELECT 1, Id_Manga, 8.09 FROM Manga WHERE titre = 'Soul Eater';
